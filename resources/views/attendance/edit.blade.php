        ...
        <form action="{{ route('attendance.update', $attendance->id) }}" method="POST" id="edit-form">
            ...
            <div class="form-floating mb-4">
                <input type="text" id="check_in_time" class="form-control timepicker" name="check_in_time"
                    value="{{ old('check_in_time', Carbon\Carbon::parse($attendance->check_in_time)->format('H:i:s') ) }}" />
            ...
            <div class="form-floating mb-4">
                <input type="text" id="check_out_time" class="form-control timepicker" name="check_out_time"
                    value="{{ old('check_out_time', Carbon\Carbon::parse( $attendance->check_out_time)->format('H:i:s') ) }}" />
...
@push('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\StoreAttendanceRequest', '#edit-form') !!}
    <script>
